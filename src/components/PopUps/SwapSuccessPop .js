...
import groovyWalkAnimation from "./succes.json";
import Lottie from "lottie-react";

function SwapSuccessPop({ setSwapConfirmShow}) {
  return (
        ...
        <div className="mt-8">
          ...
          <Lottie animationData={groovyWalkAnimation} loop={true} />
              ...
              <div className="text-center my-5">
                <h2 className="text-white text-xl font-redHat font-[700]">Successful transaction</h2>

  

              </div>

              <button className="green-grad w-[100%] py-4 px-5 font-moment text-lg font-[800] text-black" onClick={() => setSwapFailShow(false)}>
              Dismiss
            </button>
          </div>
        </div>
